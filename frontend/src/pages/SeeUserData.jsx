    ...
    return (
        <>
            ...
            <div className={`${userDiv} top-0 left-0 h-screen w-full flex items-center justify-center`}>
                <div className='bg-white rounded p-4 md:w-[50%] lg:w-[40%] w-[80%] text-zinc-800'>
                    <div className='flex items-center justify-between'>
                        <h1 className='text-2xl font-semibold'>User Informention</h1>
                        <button onClick={() => { setUserDiv("hidden") }}>
                            <RxCross1 />
                        </button>
                    </div>
                    <div className="mt-2">
                        <label htmlFor="">Username:{" "}<span>{userDivData.username}</span></label>
                    </div>
                    <div className="mt-4">
